...
# Class builder helps creating anonymous classes that we can use to test our code
# We need to create new class instances to have an "empty" and "clear" class for each test
